...
Source Database       : db_appstore_dev

Target Server Type    : MYSQL
Target Server Version : 50539
File Encoding         : 65001

Date: 2017-10-23 09:22:04
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for db_appstore_application
-- ----------------------------
DROP TABLE IF EXISTS `db_appstore_application`;
CREATE TABLE `db_appstore_application` (
  `fd_id` bigint(50) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `fd_name` varchar(255) DEFAULT NULL COMMENT '应用名字',
  `fd_logo` varchar(255) DEFAULT NULL COMMENT '应用logo',
  `fd_category` bigint(50) DEFAULT NULL COMMENT '应用类别',
  `fd_introduce` text COMMENT '应用介绍',
  `fd_downloadNum` bigint(50) DEFAULT NULL COMMENT '应用下载量',
  `fd_createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `fd_updateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `fd_shortIntroduce` varchar(255) DEFAULT NULL COMMENT '短介',
  `fd_androidUrl` varchar(255) DEFAULT NULL COMMENT 'android下载链接',
  `fd_pcUrl` varchar(255) DEFAULT NULL COMMENT 'pc下载链接',
  `fd_sort` bigint(50) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`fd_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of db_appstore_application
-- ----------------------------

-- ----------------------------
-- Table structure for db_appstore_category
-- ----------------------------
DROP TABLE IF EXISTS `db_appstore_category`;
CREATE TABLE `db_appstore_category` (
  `fd_id` bigint(50) NOT NULL AUTO_INCREMENT COMMENT '主键自增',
  `fd_name` varchar(255) DEFAULT NULL COMMENT '分类名',
  `fd_pid` bigint(50) NOT NULL COMMENT '父类ID  默认0 一级',
  `fd_logo` varchar(255) DEFAULT NULL COMMENT 'logo',
  `fd_createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `fd_updateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `fd_sort` bigint(50) DEFAULT NULL COMMENT '排序',
  `fd_display` int(10) DEFAULT NULL COMMENT '是否展示0，1',
  PRIMARY KEY (`fd_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of db_appstore_category
-- ----------------------------
INSERT INTO `db_appstore_category` VALUES ('1', '应用', '0', 'xxx', '2017-10-22 15:24:29', '2017-10-22 15:24:54', '1', '1');
INSERT INTO `db_appstore_category` VALUES ('2', '游戏', '0', 'xxx', '2017-10-22 15:24:32', '2017-10-22 15:24:56', '3', '1');
INSERT INTO `db_appstore_category` VALUES ('3', '系统工具', '1', 'xxx', '2017-10-22 15:24:36', '2017-10-22 15:24:37', '3', '1');
INSERT INTO `db_appstore_category` VALUES ('5', '最新', '0', '123', '2017-10-22 15:15:29', '2017-10-22 15:24:44', '2', '1');
INSERT INTO `db_appstore_category` VALUES ('7', '最新手游', '2', 'xxx', '2017-10-22 15:22:47', '2017-10-22 15:22:47', '1', '1');
INSERT INTO `db_appstore_category` VALUES ('8', '网上购物', '1', '13', '2017-10-22 15:23:36', '2017-10-22 18:27:43', '2', '1');
INSERT INTO `db_appstore_category` VALUES ('9', '最火热', '0', '123', '2017-10-22 15:24:05', '2017-10-22 18:38:23', '4', '0');

-- ----------------------------
-- Table structure for db_appstore_image
-- ----------------------------
DROP TABLE IF EXISTS `db_appstore_image`;
CREATE TABLE `db_appstore_image` (
  `fd_id` bigint(50) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `fd_categoryId` bigint(50) DEFAULT NULL COMMENT '分类ID',
  `fd_name` varchar(255) DEFAULT NULL COMMENT '图片名称',
  `fd_display` int(10) DEFAULT NULL COMMENT '是否展示',
  `fd_sort` bigint(50) DEFAULT NULL COMMENT '排序',
  `fd_imgType` varchar(225) DEFAULT NULL COMMENT '图片类别',
  `fd_imgUrl` varchar(225) DEFAULT NULL COMMENT '图片地址',
  `fd_createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `fd_updateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`fd_id`)
...
-- ----------------------------
-- Records of db_appstore_image
-- ----------------------------
INSERT INTO `db_appstore_image` VALUES ('4', '1', '12', null, '1', '1', '20171022/6719c84146454f1790375f6794072eb2.jpg', '2017-10-22 19:42:57', '2017-10-22 20:05:29');
INSERT INTO `db_appstore_image` VALUES ('5', '1', '2', null, '2', '2', '20171022/530f69eb1b3949a5b844592554bf4a48.png', '2017-10-22 19:51:28', '2017-10-22 20:05:23');
INSERT INTO `db_appstore_image` VALUES ('6', '1', '4', null, '4', '4', '20171022/9e4d5d73582c43a2947f0da505818b8a.jpg', '2017-10-22 20:02:01', '2017-10-22 20:02:01');

-- ----------------------------
-- Table structure for db_appstore_label
-- ----------------------------
DROP TABLE IF EXISTS `db_appstore_label`;
CREATE TABLE `db_appstore_label` (
  `fd_id` bigint(50) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `fd_name` varchar(255) DEFAULT NULL COMMENT '标签名字',
  `fd_createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `fd_updateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改记录',
  `fd_logo` varchar(255) DEFAULT NULL COMMENT '标签logo',
  `fd_sort` bigint(50) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`fd_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of db_appstore_label
-- ----------------------------
...
-- ----------------------------
INSERT INTO `sys_fhlog` VALUES ('07abe6fa3d36480d820e502deafc788c', 'admin', '2017-10-22 16:33:24', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('08538405b59445e7a251593c80b89452', 'admin', '2017-10-22 13:14:25', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('0f51eef32cf44f64a39cdf8cc5b68bed', 'admin', '2017-10-22 15:48:08', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('19b3ec9a89e645f7b9384665644ac07c', 'admin', '2017-10-22 16:18:20', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('1f26167967f74bd9914c8374ff79cd3a', 'admin', '2017-10-22 14:42:56', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('2851170df67a40baa0ec6f9fe18e2e75', 'admin', '2017-10-22 16:30:30', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('2b5c1e9e8bfd4cf292717927e225f88a', 'admin', '2017-10-22 15:59:23', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('3d0404a1b0304518bfcc295e3feea4a3', 'admin', '2017-10-22 14:59:57', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('40cc40e1cddc4ae39065eeb50a1fcf1e', 'admin', '2017-10-22 15:50:40', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('4cab4faf98e74160827e1b6b614ecb8f', 'admin', '2017-10-22 19:27:11', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('4e6289634af8400fb03fc07bbaf2de48', 'admin', '2017-10-22 13:22:25', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('52fc44289a1a41cbb50382fba15c9fdd', 'admin', '2017-10-22 13:12:16', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('586d77eeebd74bfe8ba283fb6756535b', 'admin', '2017-10-22 13:11:07', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('5e325a322c7347aaa2fc0e84ef0521cd', 'admin', '2017-10-22 16:13:32', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('6a832f5b38de45debbb0ade04383f4ad', 'admin', '2017-10-22 19:37:49', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('792bf8c6c5e2477da9c4b7f4a6462e9a', 'admin', '2017-10-22 18:22:14', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('7deb05455ac4408586e7c066a046bd43', 'admin', '2017-10-22 16:15:46', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('88825f0dc243451e8bb81021439ef278', 'admin', '2017-10-22 13:42:03', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('8fb537bb19944f739dee54ebe3819d3f', 'admin', '2017-10-22 19:51:00', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('9e7376189142454d86f8c350867f81e6', 'admin', '2017-10-22 19:25:13', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('a0f385d0bc3143b7b3ee40841e24f1be', 'admin', '2017-10-22 15:13:07', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('a4792de7910748888392deb2a5c2633e', 'admin', '2017-10-22 16:08:15', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('bda220a9a4e240f39e3bee1fc1a164f4', 'admin', '2017-10-22 18:23:26', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('c673f9de5074462a88cc897701c10d85', 'admin', '2017-10-22 16:00:45', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('c808f2707c4f4e58bf3e5f082bf00e74', 'admin', '2017-10-22 13:21:07', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('caee52c00f8344f59cda33267e7d4e17', 'admin', '2017-10-22 19:42:35', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('d28922942ceb4b99ba7bef07723d4794', 'admin', '2017-10-22 16:18:52', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('d7a2629d082a41efbdd01eddb22a5d6b', 'admin', '2017-10-22 15:54:44', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('e0afce75f4b44ae69b8deb934804815c', 'admin', '2017-10-22 18:14:55', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('e4749598f297422589170104aff4b64f', 'admin', '2017-10-22 16:05:43', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('e682129c4cc5419c80e705a05cf4fdc1', 'admin', '2017-10-22 15:58:19', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('ec0410d29375441cb7ce0b865dacb67f', 'admin', '2017-10-22 19:20:32', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('ed23aaf9053449ae89be784d119c134b', 'admin', '2017-10-22 14:57:08', '登录系统');
INSERT INTO `sys_fhlog` VALUES ('f7436d1503a84616bd16f92cc93785ef', 'admin', '2017-10-22 13:39:30', '登录系统');
...
INSERT INTO `sys_menu` VALUES ('15', '微信管理', '#', '0', '4', 'menu-icon fa fa-comments purple', '2', '0');
...
INSERT INTO `sys_menu` VALUES ('69', '应用管理', '#', '0', '1', 'menu-icon fa fa-cloud-upload blue', '2', '1');
INSERT INTO `sys_menu` VALUES ('90', '应用上传', 'fhfile/list.do', '69', '1', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('91', '分类管理', '#', '0', '1', 'menu-icon fa fa-leaf black', '2', '1');
INSERT INTO `sys_menu` VALUES ('92', '应用分类管理', 'category/list.do', '91', '1', 'menu-icon fa fa-leaf black', '1', '1');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理组', '8665581455588719690711556062', '0', '1', '1', '1', '1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', 'FH', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2017-10-22 19:51:00', '0:0:0:0:0:0:0:1', '0', 'admin', 'default', 'QQ313596790@main.com', '001', '18788888888');
...
INSERT INTO `sys_user` VALUES ('371b92633e874f989cdaeb300cfaa64b', 'bovenn', 'e4e38a1f062d3fad3cf092bc0e6ba02ca10532cd', '123456', '', '3', '', '', '0', '2132', 'default', '2132@qq.com', 'bovenn', '15928609737');
